...
HD_PWD='/home/mark01/CESEL-CW305-test/CESEL-CW305-test.runs/synth_CESEL-CW305-test'
cd "$HD_PWD"
...
EAStep vivado -log cw305_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cw305_top.tcl
